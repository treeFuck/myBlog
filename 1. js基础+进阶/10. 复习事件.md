...
- **mouseenter**：鼠标进入选中元素触发，**不能冒泡**，所以在子元素上不触发
- **mouseleave**：鼠标离开选中元素触发，**不能冒泡**，所以在子元素不触发
- **mouseover**：鼠标进入选中元素触发，**可以冒泡**，所以不论鼠标进入被选元素还是任何子元素都会触发
- **mouseout**：鼠标离开选中元素触发，**可以冒泡**，所以不论鼠标离开被选元素还是任何子元素都会触发
